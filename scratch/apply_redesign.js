...
console.log(`Hero block found: indices ${startIndex} to ${endIndex}`);
...
// Replace the original block with customStyleBlock + newHeroHtml
const finalContent = content.substring(0, startIndex) + customStyleBlock + newHeroHtml + content.substring(endIndex);

// Backup index.html first
fs.writeFileSync('index.html.bak_before_redesign', content, 'utf8');

// Write changes
fs.writeFileSync(htmlFile, finalContent, 'utf8');
console.log('Successfully applied hero redesign and backup saved!');
