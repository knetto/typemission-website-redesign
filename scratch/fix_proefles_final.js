...
// 1. Comprehensive CSS rules matching TypeMission exact brand styling
const cssRules = `
<style id="proefles-mobile-redesign">
/* TypeMission Mobile Proefles Styling - Brand Aligned & Bug-Free */
@media (max-width: 1024px) {
  ...
  /* Video Hero Container - Fixed aspect ratio 16:9, crisp framing */
  ...
  .elementor-51 .elementor-element.elementor-element-b89a0d5 {
    ...
    border: 2px solid rgba(136, 164, 236, 0.25) !important;
  ...
  /* Hide elementor recaptcha placeholder dot */
  ...
  /* CRITICAL FIX: Checkbox Acceptance Field (Replaces giant white square bug) */
  ...
  /* Force override Elementor's .elementor-field styles on checkbox */
  ...
  /* Submit button styling - TypeMission Accent Button */
  ...
  .elementor-51 .elementor-element.elementor-element-2407457 .elementor-button[type=submit] {
    ...
    align-items: center !important;
    justify-content: center !important;
    background-color: var(--e-global-color-accent, #e48e35) !important;
    background-image: linear-gradient(135deg, #e48e35 0%, #f5b05f 100%) !important;
    border-radius: 10px !important;
    font-family: 'Orbitron', sans-serif !important;
    ...
    text-transform: uppercase !important;
    color: #ffffff !important;
    border: 3px solid #e48e35 !important;
  ...
  .elementor-51 .elementor-element.elementor-element-2407457 .elementor-button[type=submit]:focus {
    background-image: linear-gradient(135deg, #f5b05f 0%, #e48e35 100%) !important;
    transform: translateY(-1px) !important;
...
// Insert share card right before the form div
...
// 3. Form Title Badge inside the form
...
console.log('Successfully applied final bugfix and TypeMission styling to proefles/index.html');
