...
// 1. Remove all old custom style tags and duplicate share cards completely
...
// 2. Add the exact, high-end TypeMission mobile CSS
const exactTypeMissionCss = `
<style id="proefles-mobile-redesign">
/* TypeMission Mobile Proefles - 100% Brand-Matching Design */
@media (max-width: 1024px) {
  /* Parent Section Container - White/Neutral page bg like homepage */
  ...
  .elementor-51 .elementor-element.elementor-element-ff0187c {
    ...
    box-shadow: 0 10px 30px rgba(59, 7, 51, 0.2) !important;
  ...
  /* Main Hero Container Card - Solid TypeMission Purple (#3b0733) */
  ...
  .elementor-51 .elementor-element.elementor-element-b89a0d5 {
    ...
    border-radius: 20px !important;
    box-shadow: 0 12px 35px rgba(59, 7, 51, 0.3) !important;
  ...
  /* WhatsApp Share Card - Styled as TypeMission Periwinkle Card (#88a4ec) */
  .tm-share-child-card {
    background: #88a4ec !important;
...
html = html.replace('</head>', `${exactTypeMissionCss}\n</head>`);

// 3. SINGLE, SINGLETON Share Card HTML (NO duplicate!)
const shareCardHtml = `
...
// Insert ONE share card right before the form div
...
console.log('Successfully updated proefles/index.html with exact TypeMission design & removed duplicates');
