...
@media (max-width: 1024px) {
  ...
  /* Video Hero Container - Aspect ratio 16:9 widescreen, no cropping */
  ...
  /* WhatsApp Share Card - TypeMission Periwinkle Blue Card (#88a4ec) */
  .tm-share-child-card {
    background: #88a4ec !important;
...
// Insert ONLY ONCE before form 2407457
...
console.log('Successfully applied clean single update!');
