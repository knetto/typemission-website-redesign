...
const updatedContent = content.slice(0, startIdx + startTag.length) + newStyles + content.slice(endIdx);
fs.writeFileSync(filePath, updatedContent, 'utf-8');
console.log('Successfully updated CSS sizes inside index.html!');
