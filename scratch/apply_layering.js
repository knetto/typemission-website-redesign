...
const newStyles = `
  ...
  .elementor-316 .elementor-element.elementor-element-143ce33 {
    position: relative !important;
    z-index: 5 !important; /* Kept text/buttons on very top */
  ...
  .hero-layer-heli {
    top: 15%;
    left: 43%; /* Positioned relative to entire hero, flying left of spies */
    width: 12%;
    z-index: 2; /* Behind spies (z-index 3) */
  }
  .hero-layer-heli img {
    width: 100%;
    height: auto;
  ...
  .hero-layer-spies {
    bottom: -15%;
    left: 51%; /* Positioned relative to entire hero, next to divider */
    height: 125%;
    width: auto;
    z-index: 3; /* In front of helicopter */
  }
...
// 2. Locate and update HTML structure
const startHtmlIdx = content.indexOf('<div class="elementor-element elementor-element-fcba14e');
const endHtmlIdx = content.indexOf('<div class="hero-mobile-image-clip">');
...
// Recreate the HTML section cleanly
const newHtmlContent = `<div class="elementor-element elementor-element-fcba14e e-con-full e-flex e-con e-child hero-container-redesign" data-id="fcba14e" data-element_type="container" data-e-type="container" data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
  <!-- Parallax visual layers for desktop/tablet -->
  ...
  <!-- Spies placed outside so they can overlap the purple background and hover in front of the helicopter -->
  <div class="hero-layer hero-layer-spies" data-depth="0.10">
    <img src="afbeelingen/spies.webp" alt="Spionnen">
  </div>
  
  <!-- Typing Girl placed outside, sitting in the bottom right corner -->
...
content = content.slice(0, startHtmlIdx) + newHtmlContent + content.slice(endHtmlIdx);

fs.writeFileSync(filePath, content, 'utf-8');
console.log('Successfully updated layering and z-indexes in index.html!');
