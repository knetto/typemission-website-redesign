...
const replacementMobileCSS = `    /* Default layout for narrow mobile screens (<380px): align text to the left, button to the right */
...
console.log('Scanning HTML files to apply conditional centering...');
...
console.log(`Conditional centering V2 complete! Modified ${count} HTML files.`);
